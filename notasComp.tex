...
Las variables son abstracciones que consisten en un lugar de memoria al que se le asigna un nombre, dentro de cual se pueden guardar distintos valores. Nombres válidos de variable son secuencias de caracteres alfanuméricos y <<\_>> en los que el primer carácter no es un número. Algunos ejemplos de nombres válidos de variable son {\tt x, x1, total, altura\_caja}.
