...
\begin{ejercicio}
	Dar interpretaciones como las anteriores para las otras reglas. Sugerencia para la eliminación del existencial: usar la notación $\phi(x)$ y considerar lo siguiente, <<sé que existe un $x$ que cumple cierta propiedad; sea $x$ un elemento que la cumple; uso ese $x$ para probar algo>>.
\end{ejercicio}
